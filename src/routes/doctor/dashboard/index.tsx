      ...
      <MainPanel>
        ...
        <div className="grid grid-cols-2 gap-4 pt-4">
          <div className="rounded-2xl border border-slate-200/80 bg-white/80 p-5 shadow-[0_2px_12px_rgba(15,23,42,0.06)] backdrop-blur-sm">
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-[32px] font-bold text-slate-900 leading-none">{pacientes.length}</p>
              </div>
          ...
          <div className="rounded-2xl border border-slate-200/80 bg-white/80 p-5 shadow-[0_2px_12px_rgba(15,23,42,0.06)] backdrop-blur-sm">
            <div className="flex items-start justify-between">
              <div>
                <p className="text-[11px] font-semibold uppercase tracking-[0.08em] text-slate-400 mb-1.5">Resultados de la Búsqueda</p>
                <p className="text-[32px] font-bold text-slate-900 leading-none">{pacientesFiltrados.length}</p>
              </div>
        ...
        <div className="grid grid-cols-3 gap-4 pt-4">
          ...
          <div className="col-span-2 rounded-2xl border border-slate-200/80 bg-white/80 shadow-[0_2px_12px_rgba(15,23,42,0.06)] backdrop-blur-sm overflow-hidden">
            <div className="flex items-center justify-between px-5 py-4 border-b border-slate-100">
              <h2 className="text-[14px] font-bold text-slate-800">Pacientes Registrados</h2>
            ...
            <table className="w-full">
              ...
              <tbody className="divide-y divide-slate-100">
                {isLoading ? (
                  ...
                  const iniciales = p.nombre.split(' ').map(n => n[0]).slice(0, 2).join('')
                  return (
